...
export default class DocsSheetDirectives extends BaseCommand {
  static override description = "활동지 입력란 directive 문법 가이드를 출력합니다.";

  // AIDEV-NOTE: docs 명령은 인증이 필요 없지만, BaseCommand를 상속하므로
  // --token 없이 실행할 수 있도록 required: false로 오버라이드.
  static override flags = {
    output: BaseCommand.baseFlags.output,
  };
